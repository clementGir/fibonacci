...
$(window).load(function(){function o(){if($(window).height()>875){var o=($(window).height()-200)/9;$(".color").height(o)}else $(".color").height(75);var r=$(document).height();$(".overlay").height(r)}function r(o){setTimeout(function(){var r=$(o).val(),a=e(r),t=0,i=0;$(".left .color").each(function(){t++;var o=a.left[t];$(this).css("backgroundColor",o),$(this).empty(),$(this).append("<p>"+o+"</p>")}),$(".right .color").each(function(){i++;var o=a.right[i];$(this).css("backgroundColor",o),$(this).empty(),$(this).append("<p>"+o+"</p>")}),$("#color").css("borderColor","#"+r)},13)}function e(o){var r={};r.left=[],r.right=[];for(var e=0;10>e;e++){var t;switch(e){case 0:t=2;break;case 1:t=3;break;case 2:t=5;break;case 3:t=8;break;case 4:t=13;break;case 5:t=21;break;case 6:t=34;break;case 7:t=55;break;case 8:t=89;break;case 9:t=144}t/=250;var i=a(o,t),c=a(o,-t);r.left.push(i),r.right.push(c)}return r}function a(o,r){o=String(o).replace(/[^0-9a-f]/gi,""),o.length<6&&(o=o[0]+o[0]+o[1]+o[1]+o[2]+o[2]),r=r||0;var e,a,t="#";for(a=0;3>a;a++)e=parseInt(o.substr(2*a,2),16),e=Math.round(Math.min(Math.max(0,e+e*r),255)).toString(16),t+=("00"+e).substr(e.length);return t}o(),$(window).resize(function(){o()}),$(".close--modal").click(function(){$(".modal").addClass("hidden--1"),setTimeout(function(){var o=$(".modal").width(),r=$(".modal").height();$(".modal").width(o).height(r),$(".modal").addClass("hidden--2"),$(".overlay").addClass("hidden")},600),setTimeout(function(){$(".modal").remove()},1e3)}),$("input").focus(function(){this.select()});var t=$("#colorPicker").val();t=t.substring(1),$("#color").val(t),$("#colorPicker").minicolors(),r($("#color")),$("#colorPicker").change(function(){var o=$("#colorPicker").val();o=o.substring(1),$("#color").val(o),r($("#color"))}),$("#color").bind("blur keydown",function(o){r(this);var e=$("#color").val();e="#"+e,$("#colorPicker").val(e)})});